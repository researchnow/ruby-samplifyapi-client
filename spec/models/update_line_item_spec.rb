...
# Unit tests for SamplifyAPIClient::UpdateLineItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateLineItem' do
  before do
    # run before each test
    @instance = SamplifyAPIClient::UpdateLineItem.new
  end
  ...
  describe 'test an instance of UpdateLineItem' do
    it 'should create an instance of UpdateLineItem' do
      expect(@instance).to be_instance_of(SamplifyAPIClient::UpdateLineItem)
    end
  end

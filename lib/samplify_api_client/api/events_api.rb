...
module SamplifyAPIClient
  class EventsApi
    ...
    def events_createproject(payload, opts = {})
      data, _status_code, _headers = events_createproject_with_http_info(payload, opts)
      data
    end
    ...
    # @param payload 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateProject, Fixnum, Hash)>] CreateProject data, response status code and response headers
    def events_createproject_with_http_info(payload, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventsApi.events_createproject ...'
      end
      # verify the required parameter 'payload' is set
      if @api_client.config.client_side_validation && payload.nil?
        fail ArgumentError, "Missing the required parameter 'payload' when calling EventsApi.events_createproject"
      end
      # resource path
      local_var_path = '/sample/v1/events/lineItems/createproject'
      ...
      header_params = {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['application/vnd.createproject+json'])
      # HTTP header 'Content-Type'
      header_params['Content-Type'] = @api_client.select_header_content_type(['application/json', 'application/xml', 'application/gob', 'application/x-gob'])
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CreateProject')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventsApi#events_createproject\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # get events
    ...
    # @param [Hash] opts the optional parameters
    # @return [StateChange]
    def events_state_change(payload, opts = {})
      data, _status_code, _headers = events_state_change_with_http_info(payload, opts)
      data
    end
    ...
    # @param payload 
    # @param [Hash] opts the optional parameters
    # @return [Array<(StateChange, Fixnum, Hash)>] StateChange data, response status code and response headers
    def events_state_change_with_http_info(payload, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventsApi.events_state_change ...'
      end
      # verify the required parameter 'payload' is set
      if @api_client.config.client_side_validation && payload.nil?
        fail ArgumentError, "Missing the required parameter 'payload' when calling EventsApi.events_state_change"
      end
      # resource path
      local_var_path = '/sample/v1/events/lineItems/stateChange'
      ...
      header_params = {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['application/vnd.statechange+json'])
      # HTTP header 'Content-Type'
      header_params['Content-Type'] = @api_client.select_header_content_type(['application/json', 'application/xml', 'application/gob', 'application/x-gob'])
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'StateChange')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventsApi#events_state_change\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end

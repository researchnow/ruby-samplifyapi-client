...
module SamplifyAPIClient
  class RespondentApi
    ...
    # @return [nil]
    def respondent_dedupe(opts = {})
      respondent_dedupe_with_http_info(opts)
      nil
    end
    ...
    def respondent_dedupe_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RespondentApi.respondent_dedupe ...'
      end
      # resource path
      local_var_path = '/respondent/dedupe'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RespondentApi#respondent_dedupe\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end

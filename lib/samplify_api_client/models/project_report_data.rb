...
module SamplifyAPIClient
  class ProjectReportData
    ...
    def hash
      [actual_median_loi, attempts, completes, conversion, currency, estimated_cost, ext_project_id, incurred_cost, line_items, overquotas, remaining_completes, screenouts, state, title].hash
    end

...
module SamplifyAPIClient
  class DetailedQuotaGroupReportData
    # quota group report details for the lineitem
    attr_accessor :quota_cells

    # ID of the quota group
    ...
    def self.swagger_types
      {
        :'quota_cells' => :'Array<DetailedQuotaCellReportData>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'quotaCells')
        if (value = attributes[:'quotaCells']).is_a?(Array)
          self.quota_cells = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @quota_cells.nil?
        invalid_properties.push('invalid value for "quota_cells", quota_cells cannot be nil.')
      end
    ...
    def valid?
      return false if @quota_cells.nil?
    ...
    def hash
      [quota_cells, quota_group_id, stats].hash
    end

...
module SamplifyAPIClient
  class CreateProjectPayload
    ...
    # Quota groups within this line item
    ...
    def self.swagger_types
      {
        ...
        :'order_number' => :'String',
        :'project_id' => :'Integer',
        :'quota_groups' => :'Array<QuotaGroupDat>',
        :'quote_id' => :'String',
        :'request_id' => :'String',
    ...
    def hash
      [error_msg, order_number, project_id, quota_groups, quote_id, request_id, sales_order_id, status].hash
    end

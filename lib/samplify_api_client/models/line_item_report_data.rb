...
module SamplifyAPIClient
  class LineItemReportData
    ...
    def hash
      [actual_median_loi, attempts, completes, completes_refused, conversion, country_iso_code, currency, estimated_cost, ext_line_item_id, incompletes, incurred_cost, language_iso_code, last_accepted_incidence_rate, last_accepted_loi, overquotas, remaining_completes, screenouts, state, state_reason, title].hash
    end

...
module SamplifyAPIClient
  class BuyProjectItem
    # A unique identifier for your Line Item
    attr_accessor :ext_line_item_id

    # Survey Test URL. Required for survey verification
    ...
    def list_invalid_properties
      ...
      if @survey_test_url.nil?
        invalid_properties.push('invalid value for "survey_test_url", survey_test_url cannot be nil.')
      end

      if @survey_url.nil?
        invalid_properties.push('invalid value for "survey_url", survey_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @survey_test_url.nil?
      return false if @survey_url.nil?
      true
    end

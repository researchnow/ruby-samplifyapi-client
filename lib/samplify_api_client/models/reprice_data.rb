...
module SamplifyAPIClient
  class RepriceData
    ...
    # Reason for event: LOI_CHANGE, IR_CHANGE, IR_AND_LOI_CHANGE, UNKNOWN
    ...
    def valid?
      ...
      reason_validator = EnumAttributeValidator.new('String', ['LOI_CHANGE', 'IR_CHANGE', 'IR_AND_LOI_CHANGE', 'UNKNOWN'])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('String', ['LOI_CHANGE', 'IR_CHANGE', 'IR_AND_LOI_CHANGE', 'UNKNOWN'])

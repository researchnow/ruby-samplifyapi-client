...
module SamplifyAPIClient
  class TemplateData
    ...
    # specifies if the template is editable or noe
    ...
    def hash
      [country_iso_code, created_at, description, editable, id, language_iso_code, name, quota_plan, state, tags, updated_at].hash
    end

...
module SamplifyAPIClient
  class Cost
    ...
    # Detailed cost with price breakdown
    attr_accessor :detailed_cost
    ...
    def self.swagger_types
      {
        :'cost_per_unit' => :'Float',
        :'currency' => :'String',
        :'detailed_cost' => :'Array<DetailedCost>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'detailedCost')
        if (value = attributes[:'detailedCost']).is_a?(Array)
          self.detailed_cost = value
        end
      end
    ...
    def hash
      [cost_per_unit, currency, detailed_cost, estimated_cost, incurred_cost].hash
    end

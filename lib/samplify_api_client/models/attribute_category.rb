...
module SamplifyAPIClient
  class AttributeCategory
    ...
    def self.swagger_types
      {
        :'main_category' => :'AttrCategory',
        :'sub_category' => :'AttrCategory'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mainCategory')
        self.main_category = attributes[:'mainCategory']
      end
    ...
    def hash
      [main_category, sub_category].hash
    end

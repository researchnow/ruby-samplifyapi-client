...
module SamplifyAPIClient
  class TargetingAttribute
    ...
    # option to exclude or include the options for the particular feature id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'attributeId')
        self.attribute_id = attributes[:'attributeId']
      end
    ...
    def hash
      [attribute_id, operator, options].hash
    end

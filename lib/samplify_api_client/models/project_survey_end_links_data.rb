...
module SamplifyAPIClient
  class ProjectSurveyEndLinksData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entryLink')
        self.entry_link = attributes[:'entryLink']
      end
    ...
    def list_invalid_properties
      ...
      if @end_links.nil?
        invalid_properties.push('invalid value for "end_links", end_links cannot be nil.')
      end

      if @entry_link.nil?
        invalid_properties.push('invalid value for "entry_link", entry_link cannot be nil.')
      end
    ...
    def hash
      [end_links, entry_link, security_key1, security_key2, security_level].hash
    end

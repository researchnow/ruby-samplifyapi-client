...
module SamplifyAPIClient
  # TokenMedia media type (default view)
  class TokenMedia
    # Access token
    ...
    attr_accessor :refresh_expires_in
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'refreshExpiresIn')
        self.refresh_expires_in = attributes[:'refreshExpiresIn']
      end
    ...
    def list_invalid_properties
      ...
      if @refresh_expires_in.nil?
        invalid_properties.push('invalid value for "refresh_expires_in", refresh_expires_in cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @refresh_expires_in.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          refresh_expires_in == o.refresh_expires_in &&
    ...
    def hash
      [access_token, expires_in, refresh_expires_in, refresh_token].hash
    end

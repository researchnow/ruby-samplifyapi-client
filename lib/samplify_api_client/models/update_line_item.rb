...
module SamplifyAPIClient
  class UpdateLineItem
    ...
    def hash
      [country_iso_code, days_in_field, delivery_type, indicative_incidence, language_iso_code, length_of_interview, quota_plan, required_completes, survey_test_url, survey_test_url_params, survey_url, survey_url_params, targets, title].hash
    end

...
module SamplifyAPIClient
  class CountryData
    ...
    def self.swagger_types
      {
        ...
        :'id' => :'String',
        :'iso_code' => :'String',
        :'supported_languages' => :'Array<SupportedLanguage>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'supportedLanguages')
        if (value = attributes[:'supportedLanguages']).is_a?(Array)
    ...
    def hash
      [country_name, id, iso_code, supported_languages].hash
    end

...
module SamplifyAPIClient
  class StudyMetadataInfo
    ...
    def self.swagger_types
      {
        ...
        :'delivery_types' => :'Array<StudyMetadataItem>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @delivery_types.nil?
        invalid_properties.push('invalid value for "delivery_types", delivery_types cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @delivery_types.nil?
      true
    end
